    ...
    while (sc.hasNext()) {
      ...
      switch (command) {
        ...
        case "scale":
          ...
          break;
        case "layer_number_2":
          builder.setLayerNumber(2);
          break;

        case "layer2_rectangle":
          RectangleInfo rinfo2 = readRectangleInfo(sc);
          builder.addRectangle2(
                  rinfo2.getName(),
                  rinfo2.getX(), rinfo2.getY(),
                  rinfo2.getWidth(), rinfo2.getHeight(),
                  rinfo2.getR(), rinfo2.getG(), rinfo2.getB(),
                  rinfo2.getStart(), rinfo2.getEnd());
          break;
        case "layer2_oval":
          OvalInfo cinfo2 = readOvalInfo(sc);
          builder.addOval2(
                  cinfo2.getName(),
                  cinfo2.getX(), cinfo2.getY(),
                  cinfo2.getXRadius(), cinfo2.getYRadius(),
                  cinfo2.getR(), cinfo2.getG(), cinfo2.getB(),
                  cinfo2.getStart(), cinfo2.getEnd());
          break;


        case "layer_number_3":
          builder.setLayerNumber(3);
          break;

        case "layer3_rectangle":
          RectangleInfo rinfo3 = readRectangleInfo(sc);
          builder.addRectangle3(
                  rinfo3.getName(),
                  rinfo3.getX(), rinfo3.getY(),
                  rinfo3.getWidth(), rinfo3.getHeight(),
                  rinfo3.getR(), rinfo3.getG(), rinfo3.getB(),
                  rinfo3.getStart(), rinfo3.getEnd());
          break;
        case "layer3_oval":
          OvalInfo cinfo3 = readOvalInfo(sc);
          builder.addOval3(
                  cinfo3.getName(),
                  cinfo3.getX(), cinfo3.getY(),
                  cinfo3.getXRadius(), cinfo3.getYRadius(),
                  cinfo3.getR(), cinfo3.getG(), cinfo3.getB(),
                  cinfo3.getStart(), cinfo3.getEnd());
          break;
        default:
