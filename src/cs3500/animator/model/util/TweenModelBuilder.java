...
public interface TweenModelBuilder<T> {
  ...
  /**
   * get the layer number information
   * @param number the number of layer
   * @return
   */
  TweenModelBuilder<T> setLayerNumber(int number);

  TweenModelBuilder<T> addRectangle2(String name,
                                      float lx, float ly,
                                      float width, float height,
                                      float red, float green, float blue,
                                      int startOfLife, int endOfLife);

  TweenModelBuilder<T> addOval2(String name,
                                float cx, float cy,
                                float xRadius, float yRadius,
                                float red, float green, float blue,
                                int startOfLife, int endOfLife);

  TweenModelBuilder<T> addRectangle3(String name,
                                     float lx, float ly,
                                     float width, float height,
                                     float red, float green, float blue,
                                     int startOfLife, int endOfLife);

  TweenModelBuilder<T> addOval3(String name,
                                float cx, float cy,
                                float xRadius, float yRadius,
                                float red, float green, float blue,
                                int startOfLife, int endOfLife);
